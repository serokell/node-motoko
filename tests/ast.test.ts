...
describe('ast', () => {
    ...
    // TODO: parseMotokoTyped has API of error recovery, but still drop the value
    // test('parseMotokoTyped with error recovery', async () => {
    //    const file = mo.file('AST.mo');
    //    file.write(badActorSource);
    //    let [prog0, cache0] = file.parseMotokoTyped(new Map<string, Scope>(), /*enableRecovery=*/true);
    // });
});
